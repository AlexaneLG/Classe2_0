    ...
    <div class="container">
        <ul class="nav navbar-nav" style="margin-left: 10%">
           <!-- <li class="list-unstyled"><a href="Main.php" style="color:black; font-size: 250%; text-decoration: none">Class 2.0</a></li>-->
            <li class="list-unstyled"><img src="Home.png" width="50" height="50" alt="" onclick="window.location='Main.php';"></li>
            <li class="dropdown" style="margin-left: 50px">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color:black;">Supports de cours<span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li class="dropdown-submenu">
                        <a class="matiere" tabindex="-1" href="#">Informatique <span class="glyphicon glyphicon-triangle-right pull-right" style="font-size: 80%; padding-top: 3%"></span></a>
                        <ul class="dropdown-menu">
                            <li><a tabindex="-1" href="Cours.php">Cours</a></li>
                            <li><a tabindex="-1" href="#">Exercices</a></li>
                            <li><a tabindex="-1" href="#">Instituteurs</a></li>
                        </ul>
                    </li>

                    <li class="dropdown-submenu">
                        <a class="matiere" tabindex="-1" href="#">Mathématiques <span class="glyphicon glyphicon-triangle-right pull-right" style="font-size: 80%; padding-top: 3%"></span></a>
                        <ul class="dropdown-menu">
                            <li><a tabindex="-1" href="#">Cours</a></li>
                            <li><a tabindex="-1" href="#">Exercices</a></li>
                            <li><a tabindex="-1" href="#">Instituteurs</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown-submenu">
                        <a class="matiere" tabindex="-1" href="#">Physiques <span class="glyphicon glyphicon-triangle-right pull-right" style="font-size: 80%; padding-top: 3%"></span></a>
                        <ul class="dropdown-menu">
                            <li><a tabindex="-1" href="#">Cours</a></li>
                            <li><a tabindex="-1" href="#">Exercices</a></li>
                            <li><a tabindex="-1" href="#">Instituteurs</a></li>
            ...
            <li><a href="#" style="color: black;">Cours en direct</a></li>
            <li><a href="RendezvousPage.php" style="color: black;">Prendre un rendez-vous</a></li>

            <li>
                <form class="navbar-form navbar-left">
                    <div class="input-group has-feedback" style="display:inline-flex; width:100%" >
                        <input type="text" class="form-control" id="search" placeholder="Search">
                        <div class="input-group-btn">
                            <button class="btn btn-default" type="submit">
                                <i class="glyphicon glyphicon-search" style="font-size: 100%"></i>
                            </button>
                        </div>
...
<!--<script>
    $(document).ready(function(){
        $('.dropdown-submenu a.matiere').on("click", function(e){
            $(this).next('ul').toggle();
            e.stopPropagation();
            e.preventDefault();
        });
